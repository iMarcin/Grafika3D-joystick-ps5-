...
namespace grafika3d
{
    //sfera, pisane przy pomocy http://blog.andreaskahler.com/2009/06/creating-icosphere-mesh-in-code.html i mozliwosc powielania do bardziej "okraglej" sfery
    public class Sfera : Mesh
    {
        public Sfera(float radius, uint subdivisions, Vec4 color)
        {
                ...
                foreach (var item in tris) Trojkaty.Add(item);
            }
